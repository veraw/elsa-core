...
public class WorkflowsFeature : FeatureBase
{
    ...
    private void AddElsaCore(IServiceCollection services)
    {
        ...
        services
            ...
            .AddScoped<IActivityOutputTransformation, DataSetToDictionaryArrayOutputTransformation>()
            .AddScoped<IActivityOutputTransformation, JObjectToDictionaryOutputTransformation>()
